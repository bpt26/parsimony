...
# usher -t ../../input/empty.nwk -v ../../CUMULATIVE_VCFS/1.vcf -o 1_samples.ml.iqtree.0.pb
...
for i in {1..50}
  ...
  # cumulative tree
    h=$((i-1));
    usher -t ${h}_samples.ml.iqtree.opt.nwk -v ../../CUMULATIVE_VCFS/${h}.vcf -o ${h}_samples.ml.iqtree.opt.pb -T 15
    usher -i ${h}_samples.ml.iqtree.opt.pb -v ../../CUMULATIVE_VCFS/${i}.vcf -o ${i}_samples.ml.iqtree.0.pb -T 15
