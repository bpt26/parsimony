...
for i in {1..25}
  do
    echo $i
    ../../pypy3.9-v7.3.10-linux64/bin/pypy3 ../../maple.py --model JC --inputTree "${i}_samples.ml.iqtree.opt.nwk" --input "../../AGGREGATE_FASTAS/${i}.diff" --calculateLKfinalTree --numTopologyImprovements 0 --noFastTopologyInitialSearch --overwrite --output ./
# Compute likelihoods under Jukes Cantor model
#    rm -f *ckp*
